         ...
         <div className="min-h-screen">
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-8 z-10">
                    <div className="absolute top-20 left-20 w-32 h-32 border border-primary-500/20 rounded-full animate-pulse"></div>
                    <div className="absolute top-40 right-32 w-24 h-24 border border-primary-500/20 rounded-full animate-pulse delay-1000"></div>
                    <div className="absolute bottom-32 left-1/4 w-16 h-16 border border-primary-500/20 rounded-full animate-pulse delay-2000"></div>
                    <div className="absolute bottom-20 right-20 w-20 h-20 border border-primary-500/20 rounded-full animate-pulse delay-500"></div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 border border-primary-600/20 rounded-full"></div>
                </div>
                ...
                <div className="absolute bottom-8 right-8 z-20">
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link 
                            to="/services" 
                            className="btn-primary hover-glow px-8 py-4 text-base font-semibold whitespace-nowrap"
                        >
                            Explore Services →
                        </Link>
                        <Link 
                            to="/contact" 
                            className="btn-white px-8 py-4 text-base font-semibold whitespace-nowrap"
                        >
                            Get in Touch
                        </Link>
                    </div>
                                    ...
                                    overlayContent={
                                        !aboutImage && (
                                            <div className="text-center">
                                                <div className="w-28 h-28 bg-gradient-to-br from-primary-500 to-accent-500 rounded-full mx-auto mb-6 flex items-center justify-center shadow-soft">
                                                    <svg className="w-14 h-14 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                                    </svg>
                                                </div>
                                                <h3 className="heading-md text-primary-950 mb-2">Collaboration</h3>
                                                <p className="body-md text-primary-600">Building together</p>
                                            </div>
                                        )
                                    }
                ...
                <div className="container-custom">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-16">
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100">
                            ...
                            <h3 className="heading-sm text-primary-950 mb-4">Telecom Solutions</h3>
                            <p className="body-md text-primary-600 text-center">Network optimization, testing, deployment</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100">
                            ...
                            <h3 className="heading-sm text-primary-950 mb-4">Automation Software Solutions</h3>
                            <p className="body-md text-primary-600 text-center">Custom automation pipelines & tools</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100">
                            ...
                            <h3 className="heading-sm text-primary-950 mb-4">Educational Empowerment & Training</h3>
                            <p className="body-md text-primary-600 text-center">Training & internship support in telecom & IT automation</p>
                        </div>
                    </div>
                ...
                <div className="container-custom">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="text-center group">
                            ...
                            <h3 className="heading-sm text-primary-950 mb-4">Innovation</h3>
                            <p className="body-md text-primary-600">Fresh ideas for real challenges.</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <h3 className="heading-sm text-primary-950 mb-4">Collaboration</h3>
                            <p className="body-md text-primary-600">Growth through teamwork.</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <h3 className="heading-sm text-primary-950 mb-4">Commitment</h3>
                            <p className="body-md text-primary-600">Quality in everything we do.</p>
                        </div>
